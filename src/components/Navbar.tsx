...
const Navbar = () => {
	...
	return (
		<nav className={`${styles.paddingX} w-full flex items-center py-5 fixed top-0 z-20 ${ isLight ? "bg-primary-light" : "bg-primary-dark" }`}>
			<div className='w-full flex justify-between items-center max-w7xl mx-auto'>
				...
				<button onClick={() => setIsLight(!isLight)} className='text-[1.5rem] justify-end'>{isLight ? '🌙' : '🌞'}</button>
