...
import { languages, frameworks, aiStack } from '../constants';
import './bounce.css';
...
const Tech = () => {
    ...
    return (
        <div id="skills" className={`mt-4 ${styles.paddingX} max-w-7xl mx-auto flex flex-col items-start justify-between`}>
            ...
            <p className={`${styles.sectionSubText} ${isLight ? "text-black-100" : "text-white-100"} font-semibold mt-4`}>AI and Automation</p>
